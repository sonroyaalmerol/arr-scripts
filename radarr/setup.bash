...
curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/AutoConfig.service -o /custom-services.d/AutoConfig
echo "Done"

echo "Download AutoExtras service..."
curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/AutoExtras.service -o /custom-services.d/AutoExtras
echo "Done"

echo "Download InvalidMoviesAutoCleaner service..."
curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/InvalidMoviesAutoCleaner.bash -o /custom-services.d/InvalidMoviesAutoCleaner
echo "Done"

echo "Download UnmappedFolderCleaner service..."
curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/UnmappedFolderCleaner.bash -o /custom-services.d/UnmappedFolderCleaner
echo "Done"
...
if [ ! -f /config/extended/naming.json ]; then
	...
	curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/naming.json -o /config/extended/naming.json 
	echo "Done"
fi

mkdir -p /config/extended
echo "Download PlexNotify script..."
curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/PlexNotify.bash -o /config/extended/PlexNotify.bash 
echo "Done"

echo "Download Extras script..."
curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/Extras.bash -o /config/extended/Extras.bash 
echo "Done"

if [ ! -f /config/extended/sma.ini ]; then
	echo "Download SMA config..."
	curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/sma.ini -o /config/extended/sma.ini 
	echo "Done"
fi
...
if [ ! -f /config/extended/recyclarr.yaml ]; then
	...
	curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/recyclarr.yaml -o /config/extended/recyclarr.yaml
	echo "Done"
fi

if [ ! -f /config/extended.conf ]; then
	echo "Download Extended config..."
	curl https://raw.githubusercontent.com/sonroyaalmerol/arr-scripts/develop/radarr/extended.conf -o /config/extended.conf
